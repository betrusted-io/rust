...
fn lend_mut_impl(
    ...
    let a3 = opcode;
    let a4 = data.as_mut_ptr().addr() as usize;
    let a5 = data.len();
    let a6 = arg1;
    let a7 = arg2;
...
fn lend_impl(
    ...
    let a3 = opcode;
    let a4 = data.as_ptr().addr() as usize;
    let a5 = data.len();
    let a6 = arg1;
    let a7 = arg2;
    let mut ret1;
...
pub(crate) unsafe fn map_memory<T>(
    ...
    let mut a1 = phys.map(|p| p.as_ptr().addr() as usize).unwrap_or_default();
    let mut a2 = virt.map(|p| p.as_ptr().addr() as usize).unwrap_or_default();
...
pub(crate) unsafe fn unmap_memory<T>(range: *mut [T]) -> Result<(), Error> {
    ...
    let mut a1 = range.as_mut_ptr().addr() as usize;
...
pub(crate) fn create_thread(
    ...
    let mut a1 = start.addr() as usize;
    let a2 = stack.as_mut_ptr().addr() as usize;
    let a3 = stack.len();
    let a4 = arg0;
    let a5 = arg1;
    let a6 = arg2;
